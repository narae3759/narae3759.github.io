...
<p style="text-align:center;">
    <img data-action="zoom" src='{{ "/assets/images/originfont.png" | relative_url }}' alt='absolute'>
    <img data-action="zoom" src='{{ "/assets/images/newfont.png" | relative_url }}' alt='absolute'>
</p>
